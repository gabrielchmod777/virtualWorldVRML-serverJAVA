...
public class Script_JS_world implements CommandTypeDependentInterpreter{
	...
	public void prepareResponse(ServerCommand execCmd, int format) {
        ...
        try {
            ...
            response = XmlWrappedResponse.response(execCmd, response.toString(),  ServerCommand.TYPE_BROADCAST, execCmd.clientPlugin, execCmd.clientPluginSource);
